...
import { highPriorityAutoGenerateEnabled, isCronEnabled } from "@/lib/content-engine/config";
...
import { runHighPriorityAutoGeneration } from "@/lib/content-engine/auto-generation";
...
export async function GET(req: NextRequest) {
  ...
  const autoGenerateHighPriority = highPriorityAutoGenerateEnabled();
  ...
  let autoGeneratedKeywords: string[] = [];
  if (cronAck && autoGenerateHighPriority && generate) {
    autoGeneratedKeywords = await runHighPriorityAutoGeneration(prioritized, 4);
  }
