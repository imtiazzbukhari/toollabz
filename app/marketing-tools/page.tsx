...
export default function MarketingToolsPage() {
  ...
  const featuredPosts = hubFeaturedPostsForGroup("marketing");
  const popularTools = hubPopularToolsForGroup("marketing");
  const collectionLd = hubCollectionLdForGroup("marketing", {
    name: "Marketing calculators",
    description: "ROI, ROAS, CPC, CPM, and conversion tools on Toollabz.",
    path: "/marketing-tools",
  });
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      ...
      <HubFeaturedGuides posts={featuredPosts} title="Featured marketing guides" />
      <section className="mt-12" aria-labelledby="mkt-popular">
        <h2 id="mkt-popular" className="text-xl font-bold text-slate-900 sm:text-2xl">
