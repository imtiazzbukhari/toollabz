...
const validCases: Array<{ slug: string; form: Record<string, string> }> = [
  ...
  { slug: "salary-after-tax-calculator-uk", form: { annualSalary: "60000", region: "england_ni", pensionPercent: "0", salarySacrificePercent: "0", studentLoan: "none" } },
  { slug: "stamp-duty-calculator-uk", form: { region: "england_ni", buyerType: "standard", propertyPrice: "295000", deposit: "0", nonUkResident: "no" } },
